            ...
            {selectedRecord ? (
              <div className="stack">
                ...
                <div style={{ padding: '0.8rem', background: 'var(--surface-muted)', borderRadius: '10px', display: 'grid', gap: '0.15rem' }}>
                  ...
                  <div className="helper-text" style={{ fontFamily: 'monospace', fontSize: '0.81rem' }}>
                    {selectedRecord.patientId?.patientId || 'No patient ID'}
                    {selectedRecord.patientId?.userId?.email ? ` · ${selectedRecord.patientId.userId.email}` : ''}
                  </div>
                </div>
