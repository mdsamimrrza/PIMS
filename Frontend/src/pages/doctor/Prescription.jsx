...
import AllergyWarningModal from '../../components/prescriptions/AllergyWarningModal';
...
export default function Prescription() {
  ...
  const handleSubmit = async (overrideReason = null) => {
    ...
    try {
      ...
      const prescriptionPayload = {
        ...
        allergyOverrideReason: overrideReason
      };
      ...
      if (patientPortal?.access) {
        setPortalCredentials({
          ...
          passwordSetupRequired: patientPortal.access.passwordSetupRequired,
          inviteDelivered: patientPortal.access.inviteEmail?.delivered ?? patientPortal.user?.inviteEmail?.delivered ?? false,
        });
        ...
        <div className="user-modal-backdrop" style={{ zIndex: 10000 }}>
          <div className="user-modal" role="dialog" aria-modal="true" style={{ width: 'min(100%, 460px)' }}>
            <div className="page-title" style={{ marginBottom: '1.5rem' }}>
              ...
              <p className="helper-text">Share the access instructions. The patient must set their password from the secure email link.</p>
            </div>
            ...
            <div style={{ background: 'var(--surface-muted)', padding: '1rem', borderRadius: '8px', marginBottom: '2rem', border: '1px solid var(--line)' }}>
              ...
              <div>
                ...
                <div style={{ marginTop: '0.2rem', fontWeight: '500' }}>
                  {portalCredentials.passwordSetupRequired ? 'Required via secure email link' : 'Already configured'}
                </div>
              </div>
            </div>
