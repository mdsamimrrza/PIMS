...
const createNewPatient = async (req, res) => {
  try {
    ...
    const patient = await createPatient(req.body || {}, actor);
...
const createPatientPortalUser = async (req, res) => {
  try {
    const actor = extractActor(req);
    const result = await createPatientPortalAccount(req.params.id, req.body || {}, actor);
